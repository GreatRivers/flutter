...
class BottomView extends StatelessWidget {
    ...
    return Column(
      children: [
        ...
        ListTile(
          ...
          onTap: () {
            Share.share(
                'Hi Download this App Now \n https://play.google.com/store/apps/details?id=com.greatrivers.biketravelart');
          },
        ),
        Divider(),
        ListTile(
  ...
  Future<void> _launchUrl() async {
    await canLaunch('https://www.m.biketravelart.com/')
        ? await launch('https://www.m.biketravelart.com/')
